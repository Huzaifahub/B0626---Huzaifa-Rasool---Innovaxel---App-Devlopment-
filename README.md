...
# Architecture
lib/
└── main.dart          # Single-file clean architecture
    ├── Expense        # Data Model
    ├── MainScreen     # Bottom Navigation Controller
    ├── HomeScreen     # Expense List + Filter
    ├── AddScreen      # Add Expense Form
    ├── EditScreen     # Edit Expense Form
    ├── SummaryScreen  # Charts + Breakdown
    └── PayScreen      # Payment Gateway UI
